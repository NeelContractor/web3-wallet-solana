...
import { ethWalletsState, mnemonicState, selectedWalletState, solWalletsState, Wallet } from "../../state/state"
...
const WalletPage = () => {
    ...
    const generateEthWallet = () => {
        ...
        setEthWallets([...ethWallets, { key: newWallet.publicKey.substring(0, 42), path: path, privateKey: newWallet.publicKey, type: "eth", amount: 0 }]);
    };
