    ...
    const handleAirdrop = async () => {
        ...
        if (selectedWallet.type === "sol") {
            ...
            try {
                ...
                console.error(e);
                toast.error(`Error in requesting airdrop, plase try after some time`, { id: toastId });
            }
        }
    }
            ...
            <div className="w-full flex flex-col items-center">
                ...
                <div className="w-full mb-2 bg-white rounded p-4 flex flex-col justify-between gap-4 md:flex-row md:items-center mt-4">
                    <div className="w-full">
                        ...
                        <p className="font-mono text-sm font-semibold text-primary text-warp text-ellipsis overflow-clip">{}selectedWallet.key</p>
                ...
                {airdropSuccess && (
                    <div className="w-full bg-white rounded p-4 flex flex-col justify-between gap-4 md:flex-row md:items-center mt-3">
                        <div className="w-full">
                            <p className="text-xs font-light">Airdrop Successfull! Changes would be reflected withiin 5 mins</p>
                        </div>
                    </div>
                )}
            </div>
